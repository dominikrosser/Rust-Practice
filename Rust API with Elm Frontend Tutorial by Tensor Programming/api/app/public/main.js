	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(book.author)
					])),
				A2(
				elm$html$Html$li,
				_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$div,
				_List_Nil,
				A2(elm$core$List$map, author$project$Main$bookView, model.books)),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$RequestBooks)
					]),
				_List_fromArray(
					[
